...
Public Class EDITCOMPANY
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If IsPostBack = False Then
            ...
            ViewState("company_id") = Val(Session("company_id"))

            If ViewState("company_id") = 0 Then
    ...
    Protected Sub btn_edit_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        Dim dob As String = DateTime.ParseExact(txt_start_dt.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("MM-dd-yyyy", CultureInfo.InvariantCulture)
        Dim exp As String = DateTime.ParseExact(txt_end_dt.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture).ToString("MM-dd-yyyy", CultureInfo.InvariantCulture)
        ...
        Try
            ...
            insToCompany.Parameters.AddWithValue("@cState", ddl_STATE.SelectedValue)
            insToCompany.Parameters.AddWithValue("@startDt", dob)
            insToCompany.Parameters.AddWithValue("@endDt", exp)
    ...
    Protected Sub txt_max_company_value_TextChanged(sender As Object, e As EventArgs) Handles txt_max_company_value.TextChanged
