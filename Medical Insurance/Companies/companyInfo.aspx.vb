...
Public Class companyInfo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack = False Then
            ...
            If dt_result.Rows.Count > 0 Then
                ...
                lbl_name_page.Text = dr_company!C_NAME_ARB
    ...
    Sub getBlockDoctors()
        Dim get_com As New SqlCommand("SELECT SER_ID, (SELECT NAME_AR FROM MAIN_MEDICALstaff WHERE MAIN_MEDICALstaff.MED_ID = INC_BLOCK_SERVICES.SER_ID) AS SERVICE_NAME, NOTES FROM INC_BLOCK_SERVICES WHERE OBJECT_ID = " & Val(Session("company_no")) & " AND BLOCK_TP = 2", insurance_SQLcon)
        Dim dt_result As New DataTable
        dt_result.Rows.Clear()
        insurance_SQLcon.Close()
        insurance_SQLcon.Open()
