...
Public Class companyInfo
    ...
    Sub getBlockDoctors()
        Dim get_com As New SqlCommand("SELECT SER_ID, (SELECT MedicalStaff_AR_Name FROM Main_MedicalStaff WHERE Main_MedicalStaff.MED_ID = INC_BLOCK_SERVICES.SER_ID) AS SERVICE_NAME, NOTES FROM INC_BLOCK_SERVICES WHERE OBJECT_ID = " & Val(Session("company_no")) & " AND BLOCK_TP = 2", insurance_SQLcon)
        Dim dt_result As New DataTable
        dt_result.Rows.Clear()
        insurance_SQLcon.Close()
        insurance_SQLcon.Open()
