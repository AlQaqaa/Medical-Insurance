<%@ Page Title="خدمات معلقة قدمت" Language="vb" AutoEventWireup="false" MasterPageFile="~/main.Master" CodeBehind="listApprovedPendingRequests.aspx.vb" Inherits="Medical_Insurance.listApprovedPendingRequests" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row mb-2">
        <div class="col-xs-12 col-sm-12">
            <div class="card mt-1 ">
                <div class="card-header bg-warning text-dark">خدمات معلقة قدمت</div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12">
                            <asp:GridView ID="GridView2" class="table table-striped table-bordered com-tbl" runat="server" Width="100%" AutoGenerateColumns="False" GridLines="None">
                                <Columns>
