        ...
        <div class="card card-body">
            ...
            <div class="row mb-2">
                ...
                <div class="col-xs-12 col-sm-3">
                    <asp:TextBox ID="txt_patient_value" CssClass="form-control" runat="server" AutoCompleteType="Disabled" placeholder="نسبة المنتفع"></asp:TextBox>
                </div>
                <div class="col-xs-12 col-sm-3">
                    <asp:TextBox ID="txt_company_value" CssClass="form-control" runat="server" AutoCompleteType="Disabled" placeholder="نسبة الشركة"></asp:TextBox>
                </div>
                <div class="col-xs-12 col-sm-3">
            ...
            <div class="row mb-2">
                <div class="col-xs-12 col-sm-2">
                    <asp:TextBox ID="txt_age" CssClass="form-control" runat="server" AutoCompleteType="Disabled" placeholder="العمر"></asp:TextBox>
                </div>
                <div class="col-xs-12 col-sm-2">
            ...
            <div class="row mb-2">
                <div class="col-xs-12 col-sm-2">
                    <%--<asp:DropDownList ID="ddl_move_type" CssClass="chosen-select drop-down-list form-control" runat="server" Width="100%">
                        <asp:ListItem Value="0">الخدمات / العمليات والإيواء</asp:ListItem>
                        <asp:ListItem Value="1">الخدمات الطبية</asp:ListItem>
                        <asp:ListItem Value="2">العمليات والإيواء</asp:ListItem>
                    </asp:DropDownList>--%>
